...
import com.example.appsimetria.bluetooth.connections.printProperties
import kotlinx.android.synthetic.main.item_custom_ble_characteristic.view.characteristic_properties
import kotlinx.android.synthetic.main.item_custom_ble_characteristic.view.characteristic_uuid
...
class CharacteristicAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = parent.context.layoutInflater.inflate(
            R.layout.item_custom_ble_characteristic,
            parent,
            false
        )
