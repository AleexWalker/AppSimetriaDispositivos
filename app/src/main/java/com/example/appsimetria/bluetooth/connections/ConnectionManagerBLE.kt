...
package com.example.appsimetria.bluetooth.connections
...
object ConnectionManager {
    ...
    private val objectCustom = CustomObject()
    ...
    fun connect(device: BluetoothDevice, context: Context, progressBar: ProgressBar) {
        if (device.isConnected()) {
            Timber.e("Already connected to ${device.address}!")
            //objectCustom.startActivity()
        } else {
    ...
    fun teardownConnection(device: BluetoothDevice) {
        if (device.isConnected()) {
            ...
            //Toast.makeText(applicationCon, "Not connected to ${device.address}, cannot teardown connection", Toast.LENGTH_SHORT).show()
